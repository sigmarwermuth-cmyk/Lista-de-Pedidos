...
export const CATALOG_PRODUCTS: Product[] = [
  ...
  { id: 'l22', name: 'Pepino', category: 'legumes', unit: 'kg', step: 1, minQty: 1, icon: '🥒' },
  ...
  { id: 'lat3', name: 'Leite Integral Aurora 1L', category: 'laticinios', unit: 'L', step: 1, minQty: 1, icon: '🥛' },
  { id: 'lat6', name: 'Presunto Fatiado', category: 'laticinios', unit: 'kg', step: 0.2, minQty: 0.2, icon: '🥓' },

  // --- AÇOUGUE & CARNES ---
  { id: 'ac2', name: 'Coxa e Sobrecoxa Aurora', category: 'acougue', unit: 'kg', step: 1, minQty: 1, icon: '🍗' },

  // --- MERCEARIA ---
  { id: 'm17', name: 'Açúcar Cristal Alto Alegre', category: 'mercearia', unit: 'pct', step: 1, minQty: 1, icon: '🍬' },
  { id: 'm18', name: 'Açúcar Cristal DoceSugar', category: 'mercearia', unit: 'pct', step: 1, minQty: 1, icon: '🍬' },
